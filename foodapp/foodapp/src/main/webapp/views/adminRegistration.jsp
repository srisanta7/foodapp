    ...
    <form:form action="${pageContext.request.contextPath}/admin/saveUser" method="post" modelAttribute="user">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <form:input path="name" id="name1" class="form-control" required="true" placeholder="Enter your full name" />
            </div>
        </div>
        ...
        <div class="form-group form-check">
            <form:checkbox path="isAdmin" id="isAdmin" class="form-check-input" />
